...
public class TerminalUtilities {
  ...
  public static byte[] buildSignatureImage(String pathData, boolean isLargeScreen) {
    String[] coordinates = pathData.split("\\^");
    int width = isLargeScreen ? 350 : 150;

    BufferedImage bmp = new BufferedImage(width, 100, BufferedImage.TYPE_INT_RGB);
    Graphics2D gfx = bmp.createGraphics();
    gfx.setColor(Color.WHITE);
    gfx.fillRect(0, 0, width, 100);
